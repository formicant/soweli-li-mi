...
const pilinPiIjoNimi = apply(tok(KulupuToki.Nimi), (toki): readonly Wan[] => [
  {
    kulupu: 'nimi',
...
const pilinPiIjoSitelen = apply(tok(KulupuToki.Sitelen), (toki): readonly Wan[] => [
  {
    kulupu: 'sitelen',
...
const pilinKon = apply(tok(KulupuToki.Kon), (_toki): readonly Wan[] => [])
